...
<div class="caption">
  A plot of the pairs of answers in columns (`HighBP`, `HighChol`), colored according to the percentage of data, at that pair, where the label was diabetic/pre-diabetic (low to high percentage is from dark purple to yellow).
</div>
